 ...
 * @version SofortLib 1.5.0  $Id: example_edit_confirmed_invoice.php 5724 2012-11-21 11:02:12Z rotsch $
...
try {
	...
	getWebPage($PnagInvoice->getPaymentUrl());	// call sofort.com to 'activate' payment
